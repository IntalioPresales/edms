...
var KTApexChartsDemo = function () {
    ...
    var _demo12 = function () {
        ...
        var options = {
            series: [44000, 55000, 13000, 43000, 22000],
            chart: {
                width: 600,
                type: 'pie',
            },
            labels: ['Ministry of public works', 'E-Yard', 'Managem', 'California constructions', 'The Ministry of Industry'],
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
        ...
        var map = AmCharts.makeChart("kt_amcharts_4", {
            ...
            "dataProvider": {
                ...
                "images": [{
                    ...
                    "images": [{
                        "label": "Project distribution by location",
                        "svgPath": planeSVG,
                        "left": 100,
                        "top": 45,
                        "labelShiftY": 5,
