			...
			columns: [
				...
				},
				{
					...
					template: function (row) {
						...
						var status = {
							1: { 'title': 'Series', 'class': ' label-light-primary' },
							2: { 'title': 'Parallel', 'class': ' label-light-info' },
							3: { 'title': 'Series', 'class': ' label-light-danger' },
						};
					...
					template: function () {
						return '\
	                        ...
	                        <a href="project_approvals_form.html" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
	                            <span class="svg-icon svg-icon-md">\
