...
var KTAppsEducationSchoolLibrary = function() {
	...
	var _demo = function() {
		var datatable = $('#kt_datatable').KTDatatable({
			...
			data: {
                type: 'local',
                source: project_file_versions_data,
			...
			columns: [
				 {
					...
					template: function(data) {
						...
						output = '<div class="d-flex align-items-center">\
							<div class="ml-4">\
								<label class="checkbox checkbox-outline" style="display: inline-table; margin-right: 10px;">\
				...
				},
				{
					...
					template: function(row) {
						...
						output += '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + row.Version + '</a>';
				...
				},
				{
					...
					template: function(row) {
						...
						output += '<a href="#" class="text-dark-50 text-hover-primary font-weight-bold">' + row.Status + ' MB</a>';
				...
				},
				 {
					...
					template: function(row) {
						...
						var status = {
							...
							3: {'title': 'Opened', 'class': ' label-light-primary'}
						};
					...
					template: function(row) {
						...
						var status = {
							1: {'title': 'Approved', 'class': ' label-light-primary'},
							2: {'title': 'None', 'class': ' label-light-info'},
	                        ...
	                        <div class="dropdown dropdown-inline">\
	                            ...
	                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">\
	                                <ul class="navi flex-column navi-hover py-2">\
                                        ...
                                        <li class="navi-item">\
	                                        <a href="project_approvals_form.html" class="navi-link">\
	                                            <span class="navi-icon"><i class="fa fa-stream"></i></span>\
	                                            <span class="navi-text">Approvals </span>\
	                                        </a>\
										</li>\
										<li class="navi-item">\
										<a href="#" class="navi-link">\
											<span class="navi-icon"><i class="fa fa-lock"></i></span>\
