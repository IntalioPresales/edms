    ...
    var _demo = function () {
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                width: 250,
                template: function (data) {
                    var number = KTUtil.getRandomInt(7, 10);
                    var img = number + '.png';
                    ...
                    if (number < 7) {
                        output = '<div class="d-flex align-items-center">\
								...
								<div class="ml-3">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.Employee + '</div>\
                        ...
                        output = '<div class="d-flex align-items-center">\
								<div class="symbol symbol-40 symbol-circle symbol-light-' + state + '">\
									<span class="symbol-label font-size-h4">' + data.Employee.substring(0, 1) + '</span>\
								</div>\
								<div class="ml-3">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0"><a href="#">' + data.Employee + '</a></div>\
								</div>\
							</div>';
                    }
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    output += '<div class="font-weight-bolder font-size-lg mb-0">' + row.Location + '</div>';
                    output += '<div class="font-weight-bold text-muted">Code: ' + KTUtil.getRandomInt(7, 1000); + '</div>';
            ...
            },
            {
                ...
                template: function (row) {
                    ...
                    output += '<div class="font-weight-bolder font-size-lg mb-0">' + row.Checklist + '</div>';
            ...
            // }, 
            {
                ...
                template: function () {
                    return '\
                        ...
                        <a href="project_inspection.html" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">\
                            <span class="svg-icon svg-icon-md">\
        ...
        var datatable2 = $('#kt_datatable2').KTDatatable({
            // datasource definition
            data: {
                type: 'local',
                source: inspections_data,
