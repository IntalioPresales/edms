			...
			columns: [
				 {
					...
					template: function(data) {
						...
						output = '<div class="d-flex align-items-center">\
							<div class="ml-4">\
								...
								<div class="text-muted font-weight-bold">#' + data.RecordID + '</div>\
							</div>\
						</div>';
					...
					template: function(row) {
						...
						var status = {
							1: {'title': 'Urgent', 'class': ' label-light-primary'},
							2: {'title': 'High Priorty', 'class': ' label-light-danger'},
							3: {'title': 'Low Priority', 'class': ' label-light-info'},
							4: {'title': 'Moderate', 'class': ' label-light-success'}
						};
	                                ...
	                                <ul class="navi flex-column navi-hover py-2">\
                                        ...
                                        <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
	                                            <span class="navi-icon"><i class="fa fa-check"></i></span>\
	                                            <span class="navi-text">Close Issue</span>\
	                                        </a>\
                                        </li>\
                                        <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
	                                            <span class="navi-icon"><i class="fa fa-level-up-alt"></i></span>\
	                                            <span class="navi-text">Reopen Issue</span>\
	                                        </a>\
	                                    </li>\
	                                    <li class="navi-item">\
	                                        <a href="#" class="navi-link">\
